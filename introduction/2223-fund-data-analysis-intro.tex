...
\begin{description}
  \item[Randomness]: Data and stochasticism.
  \item[Information:] Shannon entropy.
  \item[Bias:] Cognitive and statistical.
  \item[Outliers:] Identifying outliers in data.
  \item[Cleansing:] Fixing anomalies and inconsistencies.
\end{description}
